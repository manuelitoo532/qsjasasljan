 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var cantidad_unidad = $("#cantidad_unidad"+id).val();
			var precio_compra = $("#precio_c"+id).val();
			var precio_venta = $("#precio_v"+id).val();
			...
			$("#mod_nombre").val(producto);
			$("#mod_cantidad").val(cantidad_unidad);
			$("#mod_compra").val(precio_compra);
			$("#mod_precio").val(precio_venta);
			$("#mod_proveedor").val(proveedor);
			$("#mod_fecha").val(fecha_vencimiento);
		}
</script>