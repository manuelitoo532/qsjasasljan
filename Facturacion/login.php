        ...
        <div class="card card-container">
           ...
           <CENTER> <LABEL>AGROSERVICIO EL GALLERO</LABEL></CENTER> 
			...
			<?php
                ...
                <button type="button" class="btn btn-lg btn-success btn-block btn-signin" onclick="window.location = 'res_pass.php'">Restablecer Contraseña</button>
                <button type="button" class="btn btn-lg btn-success btn-block btn-signin" onclick="window.location = '../facturacion/select_users/index.html'">Regresar</button>
