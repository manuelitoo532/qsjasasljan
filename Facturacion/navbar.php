	<?php
      ...
      $id = $_SESSION['user_id'];
      $sle = mysqli_query($con,"SELECT rol FROM users WHERE user_id = '$id'");
      $t = mysqli_fetch_row($sle);
	?>
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../Facturacion/facturas.php">EL GALLERO</a>
    ...
    <?php } ?>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="https://www.facebook.com/MiTodoEresTu" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Soporte</a></li>
