		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_nombre" name="mod_nombre"  required >
					<input type="hidden" name="mod_idd" id="mod_id">
				</div>
			  </div>
			  
			  <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">Apellido</label>
				<div class="col-sm-8">
				...
				<div class="col-sm-3">
				  <input pattern="[0-9]{4}-[0-9]{4}" maxlength="9"  type="text" class="form-control" id="mod_telefono" name="mod_telefono" >
				</div>
				
				<i><i><label for="celular" class="col-sm-2 control-label">Celular</label></i></i>
				<div class="col-sm-3">
				  <input pattern="[0-9]{4}-[0-9]{4}" maxlength="9"  type="text" class="form-control" id="mod_celular" name="mod_celular" >
				</div>
			  </div>
			  ...
			  <div class="form-group">
			      ...
			      <div class="col-sm-4">
			          <input pattern="[0-9]{8}-[0-9]{1}" maxlength="10" type="text" class="form-control" id="mod_DUI" name="mod_DUI" >
			      </div>
			  </div>
