    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $tuser = mysqli_real_escape_string($con,(strip_tags($_POST["tuser"],ENT_QUOTES)));
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (firstname, lastname, user_name, user_password_hash, user_email, date_added,rol)
                            VALUES('".$firstname."','".$lastname."','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','".$date_added."','$tuser');";
