<?php
	...
	if (empty($_POST['mod_idd'])) {
		...
		$Celular=mysqli_real_escape_string($con,(strip_tags($_POST["mod_celular"],ENT_QUOTES)));
			$DUI=mysqli_real_escape_string($con,(strip_tags($_POST["mod_DUI"],ENT_QUOTES)));
		...
		$id_cliente=intval($_POST['mod_idd']);
		$sql="UPDATE clientes SET nombre_cliente='".$nombre."', Apellido='".$Apellido."' , telefono_cliente='".$telefono."', Celular='".$Celular."', DUI='".$DUI."' ,email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
