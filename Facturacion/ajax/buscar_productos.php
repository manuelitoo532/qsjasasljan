			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					...
					<i><th class='text-right'>Acciones</th></i>
				</tr>
				<?php
				while ($row=mysqli_fetch_array($query)){
						...
						$date_added= date('d/m/Y', strtotime($row['fecha_compra']));
					...
					<input type="hidden" value="<?php echo $producto;?>" id="producto<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $cantidad_unidad;?>" id="cantidad_unidad<?php echo $id_producto;?>">
					
					<input type="hidden" value="<?php echo number_format($precio_c,2,'.','');?>" id="precio_c<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo number_format($precio_v,2,'.','');?>" id="precio_v<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $proveedor;?>" id="proveedor<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $fecha_vencimiento;?>" id="fecha_vencimiento<?php echo $id_producto;?>">
					<tr>
						
						<td><?php echo $codigo_producto; ?></td>
						<td><?php echo $producto;?></td>
						<td><?php echo $cantidad_unidad; ?></td>
						<td><?php echo $date_added;?></td>
						<td>$ <span><?php echo number_format($precio_c,2);?></span></td>
						<td>$ <span><?php echo number_format($precio_v,2);?></span></td>
